...
const CompanyCrewRoles = () => {
  ...
  const typeMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["company-crew-types"] });
  ...
  const roleMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["company-crew-roles"] });
        ...
        <DialogContent>
          ...
          <form onSubmit={handleTypeSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={typeForm.type}
                onValueChange={(value: "company" | "crew") =>
                  setTypeForm({ ...typeForm, type: value })
                }
              >
        ...
        <DialogContent>
          ...
          <form onSubmit={handleRoleSubmit} className="space-y-4">
            <div>
              ...
              <Select
                value={roleForm.type_id}
                onValueChange={(value) =>
                  setRoleForm({ ...roleForm, type_id: value })
                }
              >
